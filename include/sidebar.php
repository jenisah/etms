...
<nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      ...
      <li <?php if($page_name == "Dashboard" ){echo "class=\"active\"";} ?>><a href="dashboard.php"><span style="font-size:16px; color:#d4ab3a;" class=" hidden-xs showopacity glyphicon glyphicon-home" ></span>&nbsp;  Dashboard</a></li>
        <li <?php if($page_name == "Task_Info" ){echo "class=\"active\"";} ?>><a href="task-info.php"><span style="font-size:16px; color:#d4ab3a;" class="hidden-xs showopacity glyphicon glyphicon-tasks" ></span> Task Mangement</a></li>
        <li <?php if($page_name == "Attendance" ){echo "class=\"active\"";} ?>><a href="attendance-info.php"><span style="font-size:16px; color:#d4ab3a;" class="hidden-xs showopacity glyphicon glyphicon-calendar"></span> Attendance </a></li>
        <li <?php if($page_name == "Admin" ){echo "class=\"active\"";} ?>><a href="manage-admin.php"><span style="font-size:16px; color:#d4ab3a;" class="hidden-xs showopacity glyphicon glyphicon-user"></span> Administration</a></li>
